<svelte:head>
  <meta name="buildtime" content={process.env.BUILDTIME} />
  <title>Mina Wordle</title>
  ...
  <meta property="og:site_name" content="Mina Wordle" />
  <meta property="og:type" content="website" />
  <meta property="og:locale" content="en" />
  <meta property="og:title" content="Mina Wordle" />
